...
#import <MTTAConfirmOrderBusinessCategory/MTMediator+MTTAConfirmOrder.h>
...
{
    UIViewController *confirmOrderVC = [[MTMediator sharedInstance] confirmOrderViewControllerWithGoodsId:self.goodsId
